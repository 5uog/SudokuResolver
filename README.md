...
$$
\mathrm{Cost}_{\mathrm{search}}
= \lambda \cdot N_{\mathrm{branch}}
+ \mu \cdot \sum_{\mathrm{branch}} \mathrm{depth}
$$
...
$$
\mathrm{Diff}
= \alpha \cdot \mathrm{Cost}_{\mathrm{logic}}
+ \beta \cdot \mathrm{Cost}_{\mathrm{search}}
- \gamma \cdot \sum_t \Delta H_t
$$
