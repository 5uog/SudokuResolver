...
$$
\mathrm{Cost}_{\mathrm{search}} = \lambda N_{\mathrm{branch}} + \mu \sum_{i=1}^{N_{\mathrm{branch}}} d_i
$$
...
$$
p = \min\left\{ 1,\; \exp\!\left( -\frac{ \lvert D - D^{*}\rvert - \lvert D_{\mathrm{prev}} - D^{*}\rvert }{T} \right) \right\}
$$
