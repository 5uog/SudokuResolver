...
$$
\mathrm{Cost}_{\text{search}} = \lambda\,N_{\text{branch}} \;+\; \mu \sum_{i=1}^{N_{\text{branch}}} d_i, \qquad \text{where } d_i=\text{depth of branch } i.
$$
...
$$
\mathrm{Diff}
= \alpha \,\operatorname{Cost}_{\text{logic}}
+ \beta \,\operatorname{Cost}_{\text{search}}
- \gamma \sum_{t=1}^{T} \Delta H_t
$$
...
p \;=\; \min\!\left\{\,1,\;
  \exp\!\left(
    -\frac{\;\bigl|\,\mathrm{Diff}-\mathrm{Diff}^*\,\bigr|
           - \bigl|\,\mathrm{Prev}-\mathrm{Diff}^*\,\bigr|}{T}
  \right)
\right\}.
$$
...
$$
\{\, x_{r,j} \mid j=1,\dots,9 \,\}, \quad
\{\, x_{i,c} \mid i=1,\dots,9 \,\},
$$
